...
public class Preenche {
	...
	public void preencher(String Prioridade, String Tipo_Prioridade, String Exeq_Liquido, String INSS_Beneficiario,
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/form[5]/div/div[2]/table[2]/tbody/tr/td[1]/button"))
				.click();
	 ...
	 * @throws WebDriverException
	 * 
	 * public void preencher(String Documento_Fiscal, String Nome, String
	 * UF_OAB, String numero_OAB, String Tipo_OAB) throws
	 ...
	 * ".//*[@id='inCpfAdv']"))).clear();
	 * driver.findElement(By.xpath(".//*[@id='inCpfAdv']")).sendKeys(
	 * Documento_Fiscal);
	 * 
	 ...
	 * else { logger.info("Nome Inativo"); System.out.println("Nome Inativo"); }
	 * 
	 * driver.findElement(By.xpath(".//*[@id='inUfOAB']")).click(); if
	 * (driver.findElement(By.xpath(".//*[@id='inUfOAB_panel']/div/ul/li")).
	 * isDisplayed()) { logger.info("Selecionando Unidade Federativa da OAB");
	 * Helper.selectFromDropdown(UF_OAB, ".//*[@id='inUfOAB_panel']/div/ul/li");
	 * logger.info("Unidade Federativa Selecionada"); } else {
	 * logger.info("Unidade Federativa Selecionada");
	 * System.out.println("Unidade Federativa Inativo"); }
	 * 
	 * if
	 * (fluentwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
	 * ".//*[@id='inNrOAB']"))) .isEnabled()) {
	 ...
	 * } else { logger.info("Numero da OAB Inativo");
	 * System.out.println("Numero da OAB Inativo"); }
	 * 
	 * driver.findElement(By.xpath(".//*[@id='inTpOAB']")).click(); if
	 * (driver.findElement(By.xpath(".//*[@id='inTpOAB_panel']/div/ul/li")).
	 * isDisplayed()) { logger.info("Selecionando Tipo de OAB");
	 * Helper.selectFromDropdown(Tipo_OAB,
	 * ".//*[@id='inTpOAB_panel']/div/ul/li"); } else {
	 ...
	 * fluentwait.until(ExpectedConditions .visibilityOfElementLocated(By.xpath(
	 * ".//*[@id='inBenef']/tbody/tr[1]/td[1]/div/div[2]/span")));
	 * 
