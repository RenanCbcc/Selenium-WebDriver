...
public class Preenche {
	...
	public void preencher(String numero, String processo, String tipo_requisição, String natureza_credito, String vara,
			String observacao, String data_ordem0, String data_ordem1, String data_ordem2, String data_ordem3,
			String data_ordem4, String data_ordem5, String cnpj_Exec, String Esfera_Exec, String Adm_Exec,
			String nome_devedor, String lei_amparo, String CPF_procurador)
			throws NoSuchElementException, TimeoutException, WebDriverException {

		logger.info("Preenchendo Numero requsicao de Pagamento");
		driver.findElement(By.id("tabGeral:inNrReq")).clear();
		driver.findElement(By.id("tabGeral:inNrReq")).sendKeys(numero);
		driver.findElement(By.id("tabGeral:j_idt83")).click();// clica no botão
																// buscar numero
																// RP

		fluentwait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tabGeral:inNrProc")));
		

		logger.info("Preenchendo Numero processo");
		driver.findElement(By.id("tabGeral:inNrProc")).clear();
		driver.findElement(By.id("tabGeral:inNrProc")).sendKeys(processo);
		driver.findElement(By.id("tabGeral:j_idt89")).click();// clica no botão
																// buscar
																// processo

		logger.info("Preenchendo Tipo de Requisicao");
		fluentwait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='tabGeral:cmbAssuntos']/tbody/tr/td[3]/div/div[2]/span")));
		
		if (tipo_requisição.equals("RPV")) {
		...
		if (isClickable(driver.findElement(By.xpath(".//*[@id='tabGeral:cmbVara']")))) { 
			if (isClickable(driver.findElement(By.xpath(vara)))) {logger.info("Vara de Origem Selecionada");}
		} else {
		...
		if (campo_bservacao.isEnabled()) {
			...
			campo_bservacao.sendKeys(observacao);
		}
		...
		if (campo_cnpj_Exec.isEnabled()) {
			...
			campo_cnpj_Exec.sendKeys(cnpj_Exec);
			...
			fluentwait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='tabGeral:cmbEsfera']")));

			if (isClickable(driver.findElement(By.xpath(".//*[@id='tabGeral:cmbEsfera']")))) {
				if (isClickable(driver.findElement(By.xpath(Esfera_Exec)))) // <==========//
																			// recebe
				// como
				// argumento
				// xpath
			...
			if (isClickable(driver.findElement(By.xpath(".//*[@id='tabGeral:cmbTpEnte']")))) {
				driver.findElement(By.xpath(Adm_Exec)).click(); // <==========
																// recebe como
																// argumento
																// xpath
			} else {
		...
		if (isClickable(driver.findElement(By.id("tabGeral:inCpfProc")))) {
			...
			driver.findElement(By.id("tabGeral:inCpfProc")).sendKeys(CPF_procurador);
		...
		fluentwait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='tabGeral:cmbDevedor']")));
		if (isClickable(driver.findElement(By.xpath(".//*[@id='tabGeral:cmbDevedor']")))) {
			if (isClickable(driver.findElement(By.xpath(nome_devedor)))) {
				logger.info("Ente Devedor selesionado");
				if (isClickable(driver.findElement(By.xpath(".//*[@id='tabGeral:cmbLegislacao']")))) {

					if (isClickable(driver.findElement(By.xpath(lei_amparo))))// <==========//
																				// recebe
					{
				...
				System.out.println("Ente Devedor nao encontrado");
			}
		...
		if (isClickable(driver.findElement(By.id("tabGeral:j_idt190")))) {
	...
	public void preencher(String numero)
		...
		logger.info("Preenchendo Numero requsicao de Pagamento");
		WebElement campo_numero = driver.findElement(By.id("tabGeral:inNrReq"));
		campo_numero.clear();
