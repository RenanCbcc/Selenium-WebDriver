...
public abstract class Helper {
	...
	public static void pageSearcher(WebDriver driver)
		...
		logger.info("Divisao de Precatorios | Diretor!");
	 ...
	 * <th style="width: 160px;" scope="col" aria-label="Respons�vel" role=
	 * "columnheader" class="ui-state-default" id=
	 * "tblRpObservacoes:j_idt139"><span class=
	 * "ui-column-title">Respons�vel</span></th>
	 * <th scope="col" aria-label="Observa��o" role="columnheader" class=
	 * "ui-state-default" id="tblRpObservacoes:j_idt141"><span class=
	 * "ui-column-title">Observa��o</span></th>
	 * </tr>
	 ...
	 * <tr role="row">
	 * <th scope="col" aria-label="Benefici�rio" role="columnheader" class=
	 * "ui-state-default" id="tabGeral:tblBeneficios:j_idt211"><span class=
	 * "ui-column-title">Benefici�rio</span></th>
	 ...
	 * hist�rico de atualiza��es" onclick=
	 ...
	 * hist�rico de
	 * atualiza��es</span></button><button type="submit" title="Visualizar
	 * hist�rico de pagamentos" onclick=
	 ...
	 * hist�rico de pagamentos</span></button></td>
	 * </tr>
	 * </tbody>
	 * </table>
	 * 
	 ...
	 *         Corporation.","82.863.545/0001-96","N�o","12.000,00"]</code>>
	 */
	 ...
	 * "selected">Pessoa F�sica</option>
	 * <option value="59b661ad-e313-460c-acef-15fb2c9d9370">Pessoa
	 * Jur�dica</option> </select> </div> </div></td>
