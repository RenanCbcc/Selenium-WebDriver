 ...
 * 'Maintain Payment Requisition' Last test of the class: 03/11/2018
 * 
...
public class Teste_inclui_requisicao_pagamento extends Report {
	...
	public void UC002_CT002_PD002_1() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
		...
		((Pagina) pagina).novo().preencher(/* Dados do Proceso */ "00001/2018", "0000006-55.2008.5.08.0009",
				...
				/* Datas de Referencia */ "01/01/2016", "08/10/2016", "09/10/2016", "10/10/2016", "11/10/2016",
				"12/10/2016"
	...
	public void UC002_CT002_PD002_4() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
		...
		page.preencher(/* Dados do Proceso */"00002/2018", "0000008-25.2008.5.08.0009", "RPV", "Alimentar",
				...
				/* Datas de Refer�ncia */ "01/01/2016", "08/11/2016", "09/12/2016", "10/01/2017", "11/02/2017",
				"12/03/2017"
				/* Dados do Executado */ , "34.621.748/0001-23", "UNIVERSIDADE FEDERAL DO PARA", "Federal", "Administração Direta"
				/* Dados do Devedor */ , "UNIVERSIDADE FEDERAL DO PARA - 34.621.748/0001-23", "Regra Geral"
				/* Dados do procurador */ , "052.430.784-92");

		Teste_Inclui_Beneficiario.incluir_Beneficiario(this.driver, "Pessoa Física", "357.579.517-70", "José Saramago",
				"10/10/1950", "Sim", "Idade", "1.000,00", "100,00", "100,00", "100,00", "1,00", "100,00",
				"Per aspera ad astra");
	...
	public void UC002_CT002_PD002_6() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
		...
		Preenche page = ((Pagina) pagina).novo();
		page.preencher(/* Dados do Proceso */ "00004/2018", "0109400-24.2004.5.08.0013", "RPV", "Alimentar",
	...
	public void UC002_CT002_PD002_7() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
		...
		Preenche page = ((Pagina) pagina).novo();
		page.preencher(/* Dados do Proceso */ "00005/2018", "0109400-24.2004.5.08.0013", "RPV", "Comum",
	...
	public void UC002_CT002_PD002_8() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
			WebDriverException, ElementNotInteractableException, InterruptedException {
		logger = extent.createTest("UC002_CT002_PD002_8");
		Preenche page = ((Pagina) pagina).novo();
	...
	public void UC002_CT002_PD002_9() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
		...
		((Pagina) pagina).novo().preencher(/* Dados do Proceso */ "00008/2018", "0000008-18.2011.5.12.0000");
	...
	/**
	 * To be finalized at the and of the the script.
	 * 
	 ...
	 */
	@Test(groups = { "Smoke testing", "Regression testing"})	
	public void UC002_CT002_PD002_10() throws NoSuchElementException, ElementNotVisibleException, TimeoutException,
			WebDriverException, ElementNotInteractableException, InterruptedException {

		logger = extent.createTest("UC002_CT002_PD002_10");
		((Pagina) pagina).novo().preencher(/* Dados do Proceso */ "00007/2018", "0000931-08.2014.5.08.0117",
				"Precatório", "Alimentar", "2ª VARA DO TRABALHO DE MARABÁ", "Test Case UC002_CT002_PD002_10",
				/* Datas de Refer�ncia */ "01/01/2016", "08/10/2016", "09/10/2016", "10/10/2016", "11/10/2016",
				"12/10/2016"
				/* Dados do Executado */ , "34.621.748/0001-23", "UNIVERSIDADE FEDERAL DO PARA", "Federal", "Administração Direta"
				/* Dados do Devedor */ , "OmniCorp - 36.417.444/0001-74", "Regra Geral"
				/* Dados do procurador */ , "448.985.451-06");
