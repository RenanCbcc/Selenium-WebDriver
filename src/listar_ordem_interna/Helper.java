 ...
 */
	...
	public static void pageSearcher(WebDriver driver)
		...
		logger.info("Divisão de Precatórios | Diretor!".toUpperCase());
		
		Actions actions = new Actions(driver);
		logger.info("Opcoes de Requisisao de pagamento!".toUpperCase());
		...
		logger.info("Listar Ordem de Pagamento".toUpperCase());
		actions.moveToElement(driver.findElement(By.xpath("/html/body/form[1]/div/ul/li[4]/ul/li[3]/a")));
		logger.info("Requisicoes de Pagamento".toUpperCase());
		actions.moveToElement(driver.findElement(By.xpath("/html/body/form[1]/div/ul/li[4]/ul/li[3]/ul/li[1]/a")))
				.click().build().perform();
	}
	...
	/**
	 * Primarily, it locates the Table and, soon after, returns all its cells, like that:
	 *  <table role="grid">
            <thead id="tblRpObservacoes_head">
               <tr role="row">
                  <th style="width: 90px;" scope="col" aria-label="Data" role="columnheader" class="ui-state-default" id="tblRpObservacoes:j_idt137"><span class="ui-column-title">Data</span></th>
                  <th style="width: 160px;" scope="col" aria-label="Responsável" role="columnheader" class="ui-state-default" id="tblRpObservacoes:j_idt139"><span class="ui-column-title">Responsável</span></th>
                  <th scope="col" aria-label="Observação" role="columnheader" class="ui-state-default" id="tblRpObservacoes:j_idt141"><span class="ui-column-title">Observação</span></th>
               </tr>
            </thead>
            <tbody class="ui-datatable-data ui-widget-content" id="tblRpObservacoes_data">
	 ...
	 * @param xpath
	 * @return List<["18/08/2017","Solimar Silva","Ab alio expectes, quod alteri feceris"]>
	 */
